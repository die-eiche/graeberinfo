...
if exist "%SRC%zaehlung.php" copy /Y "%SRC%zaehlung.php" "%DST%"
if exist "%SRC%aufrufe-statistik.js" copy /Y "%SRC%aufrufe-statistik.js" "%DST%"
...
if not exist "%DST%Historie\Dienste" mkdir "%DST%Historie\Dienste"
if exist "%SRC%Historie\Dienste\aufrufe.csv" copy /Y "%SRC%Historie\Dienste\aufrufe.csv" "%DST%Historie\Dienste\"
...
if exist "%ALIAS%" (
  ...
  if exist "%SRC%zaehlung.php" copy /Y "%SRC%zaehlung.php" "%ALIAS%"
  if exist "%SRC%aufrufe-statistik.js" copy /Y "%SRC%aufrufe-statistik.js" "%ALIAS%"
